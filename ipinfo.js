...
export default function IPInfo({ data }) {
    ...
    let imgsrc = "https://maps.googleapis.com/maps/api/staticmap?center=" + data.location.lat + ',' + data.location.lng + "&markers=color:red%7Clabel:C%7C40.718217,-73.998284&zoom=12&size=600x400&key=APIKEY"
